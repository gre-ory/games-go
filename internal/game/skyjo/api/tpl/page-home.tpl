...
<head>
    ...
    <script src="/static/skyjo/game.js" defer></script>
    <!-- css -->
    ...
    <link rel="stylesheet" href="/static/skyjo/game.css"/>
</head>
<body>
	...
	<!-- websocket -->
    <div id="main" hx-ext="ws" ws-connect="/skj/htmx/connect" hx-trigger="load">

	    <!-- header -->        
		<div id="header">
            <div class="title">{{ $lang.Loc "Title" }} - SKJ - {{ $lang.Loc "JoinAction" }}</div>
        </div>
